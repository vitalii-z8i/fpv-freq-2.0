                        ...
                        return (
                            <li
                                ...
                                <Link href={`/channels/${nc.id}`}
                                      className="border-2 border-gray-200 rounded-lg bg-rose-50 dark:bg-gray-700 dark:border-gray-700 hover:opacity-80 flex text-center items-center px-1 py-0">
